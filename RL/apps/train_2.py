...
def control_drone_target(env, waypoints,duration):
        ...
        env.drone_target.move_by_velocity(0, 0, 0, 1,True)
        #time.sleep(5)
        env.set_done()
...
def train_drone(agent,env,state,score,run):
    ...
    while not env.is_done():
        ...
        next_state, reward, done, info,s,rf = env.step(action)
...
def main():
    ...
    #agent.load_model("./output/models/best_model2.pth")
    ...
    for episode in range(n_games):
        ...
        environment.drone.move_by_velocity(2, 0, 0, 2, True)
        ...
        if episode % 50 == 0:
            ...
            if avg_score > best_score:
                ...
                agent.save_model("./output/models/best_model4.pth")
