...
class CriticNetwork(nn.Module):
    def __init__(self, lr=5e-4, input_dims=None, fc1_dims=400, fc2_dims=300, fc3_dims=100, n_actions=0,
                 name=None, checkpoint_dir="RL/models"):
        ...
        self.checkpoint_file = os.path.join(self.checkpoint_dir, name + "_fddpg")
    ...
    def forward(self, state, action):
        ...
        state_value = F.selu(state_value)
        ...
        #action_value = F.selu(self.action_value(action))
        action_value = self.action_value(action)
        state_action_value = F.selu(T.add(state_value, action_value))
...
class ActorNetwork(nn.Module):
    def __init__(self, lr=5e-4, input_dims=None, fc1_dims=600, fc2_dims=400, fc3_dims=100, n_actions=2,
                 name=None, checkpoint_dir="RL/models"):
        ...
        self.mu = nn.Linear(self.fc2_dims, self.n_actions) ####### fc2
